...
/*-----------------------------------------Element de jeux------------------------------------*/
    ...
    vitesseX = 5;                   //Vitesse de la balle
    vitesseY = -8;
    ...
    longBarre = (WINDOW_WIDTH-(largFenetre*2))/7;      //Forme de la Barre
    hauteurBarre = 15;
    ...
    longBarre2 = (WINDOW_WIDTH-(largFenetre*2))/7;                  //Forme de la Barre
    hauteurBarre2 = 15;
    deplTouche2 = 30;                //Déplacement de la Barre
...
void drawMenu(){
    ...
    if(menuHistoire<xrectMenu){
        menuHistoire=menuHistoire+avavitVictoire;
    }  

    if(menuXarcade<xrectMenu){
...
void drawBackground(){
    ...
    drawRect(0,0,500,1080);
    drawRect(1420,0,500,1080);
